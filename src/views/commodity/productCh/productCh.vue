<template>
	<div class="productCh" v-if="loading">
		...
		<div class="productCh-header el-header-normal-margin-top">
			<el-button type="primary" @click="$router.push('/commodity/product.jsp')">返回</el-button>
		</div>
		<!-- 内容 -->
		<div class="productCh-body el-header-normal-margin-top">
			<el-form label-position="right" label-width="150px" :model="form">
				...
				<el-form-item label="类别:">
					<el-cascader placeholder="未选择" :options="productDetailsArray" v-model="form.pType" :props="{multiple: true}" collapse-tags clearable @change="caScader" />
				</el-form-item>
				...
				<el-form-item label="轮播图:" style="width: 1300px;">
				  <vuedraggable class="wrapper" v-if="!disabled" v-model="form.productSlideshowList">
					<transition-group>
				...
				<el-form-item label="富文本:" style="width:1000px;">
					<editor :content="content" :height="500" @change="updateData" :z-index="100" :auto-height="true" :show-module-name="false" />
				</el-form-item>
			</el-form>
		</div>
