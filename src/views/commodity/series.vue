	...
	<div class="series" v-loading="loading">
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<div class="series-body el-body-normal-margin-top">
				<el-table :max-height="660" :data="tableData" size="mini" stripe style="width: 100%" border tooltip-effect="dark" :header-cell-style="{ background: '#eef1f6', color: '#606266' }" ref="multipleTable">
